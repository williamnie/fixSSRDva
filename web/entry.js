...
const serverRender = async ctx => {
  ...
  const Layout = ActiveComponent.Layout || defaultLayout
  const data = ActiveComponent.getInitialProps ? await ActiveComponent.getInitialProps(ctx) : {} // eslint-disable-line
  const storeState = store.getState()
  // console.log('storeState', storeState);
  ctx.serverData = { router: storeState.router, '@@dva': storeState['@@dva'], ...data }
